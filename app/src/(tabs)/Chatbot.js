  ...
  const [messages, setMessages] = useState([
    {
      isBot: true,
      name: "botER",
      text: "Hello! I'm botER, your assistant for all things related to entity-relationship queries. Before we start, please enter a chat name to ensure your chat history is saved. Otherwise, it won't be stored. How can I assist you today?",
    },
  ]);
      ...
      <div className="ChatNameContainer">
        <form onSubmit={(e) => handleChatroomIdSubmit(e)}>
          <input
            type="text"
            placeholder={
              isLoading ? "Waiting for response..." : "Enter Chatname"
            }
      ...
      <div className="TextBox">
        <form onSubmit={handleSubmit}>
          <input
            type="text"
            placeholder={
              isLoading ? "Waiting for response..." : "Message botER."
            }
            className="TextInput"
            value={inputText}
          ...
          >
            <ion-icon
              name={isLoading ? "hourglass-outline" : "arrow-up-circle"}
            ></ion-icon>
          </button>
        </form>
      </div>
